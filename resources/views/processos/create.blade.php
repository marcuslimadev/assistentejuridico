...
<div class="container-fluid">
    <div class="d-flex align-items-center mb-4 gap-3">
        ...
        <h2 class="mb-0">Cadastrar Novo Processo</h2>
    </div>

    <div class="card p-4 mx-auto shadow-sm" style="max-width: 900px;">
        <form method="POST" action="{{ route('processos.store') }}">
            @csrf
            
            <h5 class="mb-3 border-bottom border-secondary pb-2">Informações Iniciais</h5>
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    <label class="form-label">Cliente <span class="text-danger">*</span></label>
                    <select name="cliente_id" class="form-select bg-dark text-light border-secondary" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="numero_cnj" class="form-control bg-dark text-light border-secondary" placeholder="0000000-00.0000.0.00.0000" value="{{ old('numero_cnj') }}">
                    @error('numero_cnj') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
            </div>

            <h5 class="mb-3 border-bottom border-secondary pb-2">Detalhes Jurídicos</h5>
            <div class="row g-3 mb-3">
                <div class="col-md-4">
                    <label class="form-label">Tipo de Ação</label>
                    <input type="text" name="tipo_acao" class="form-control bg-dark text-light border-secondary" placeholder="Ex: Indenizatória, Divórcio..." value="{{ old('tipo_acao') }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Área do Direito</label>
                    <select name="area_direito" class="form-select bg-dark text-light border-secondary">
                ...
                <div class="col-md-4">
                    ...
                    <select name="polo" class="form-select bg-dark text-light border-secondary" required>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="partes_contrarias" class="form-control bg-dark text-light border-secondary" placeholder="Nome, CPF/CNPJ, Advogado..." value="{{ old('partes_contrarias') }}">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Valor da Causa (R$)</label>
                    <input type="number" step="0.01" name="valor_causa" class="form-control bg-dark text-light border-secondary" placeholder="0.00" value="{{ old('valor_causa') }}">
                </div>
            </div>

            <h5 class="mb-3 border-bottom border-secondary pb-2">Localização e Responsabilidade</h5>
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    <label class="form-label">Tribunal / Comarca / Vara</label>
                    <input type="text" name="comarca" class="form-control bg-dark text-light border-secondary" placeholder="Ex: TJSP - Foro de São Paulo" value="{{ old('comarca') }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Advogado Responsável</label>
                    <select name="advogado_id" class="form-select bg-dark text-light border-secondary">
                        <option value="">Selecione...</option>
