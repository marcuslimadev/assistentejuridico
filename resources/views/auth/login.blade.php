    ...
    <div class="auth-card row g-0">
      <div class="col-lg-6 auth-hero d-flex flex-column justify-content-between">
            ...
            <div class="theme-panel" id="themePanel" role="dialog" aria-label="Selecionar tema">
              <div class="theme-panel-header">
                <div>
                  ...
                  <p>Escolha qualquer tema oficial para a experiência de login e do painel.</p>
                </div>
              </div>
        ...
        <div class="logo-section">
          ...
          <p class="hero-copy mb-0">Bootswatch aplicado do jeito certo: componentes Bootstrap consistentes, contraste previsível e liberdade para o usuário escolher qualquer tema oficial.</p>
        </div>
